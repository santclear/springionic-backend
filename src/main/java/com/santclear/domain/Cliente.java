...
public class Cliente implements Serializable {
	...
	private Integer id;
	private String nome;
	@Column(unique=true) // Impede duplicação
	private String email;
	private String cpfOuCnpj;
	private Integer tipo;
	// Impede que a senha seja exibida ao ser recuperado os dados
	@JsonIgnore
	private String senha;
	
	// cascade=CascadeType.ALL quer dizer que se excluir um Cliente excluirá também os seus endereços associados
